...
3.  Read: [Introducing the Shell](https://swcarpentry.github.io/shell-novice/01-intro/)\
    Read: [Navigating Files and Directories](http://swcarpentry.github.io/shell-novice/02-filedir/)\
    Complete [this bash tutorial](https://sr320.github.io/course-fish546-2023/assignments/00-bash.html)

4.  Read: [Organize your data and code](https://kbroman.org/steps2rr/pages/organize.html)
